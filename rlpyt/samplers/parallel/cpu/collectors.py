...
class OracleCollector(DecorrelatingStartCollector):
    ...
    def collect_batch(self, agent_inputs, traj_infos, itr):
        ...
        for t in range(self.batch_T):
            ...
            for b, env in enumerate(self.envs):
                ...
                option_action = env.get_option_action()
                if option_action is not None:
                    action[b] = option_action
                    # TODO: ignoring agent_info at the moment, which I think is just used for RNNs
...
class CpuLandmarksCollector(DecorrelatingStartCollector):
    ...
    def collect_batch(self, agent_inputs, traj_infos, itr):
        ...
        for t in range(self.batch_T):
            ...
            for b, env in enumerate(self.envs):
                # Environment inputs and outputs are numpy arrays.
                o, r, d, env_info = env.step(action[b], agent_info[b].subgoal)
