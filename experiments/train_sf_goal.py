...
from rlpyt.algos.dqn.dsr.goal_dsr import GoalDSR
from rlpyt.agents.dqn.grid_dsr.grid_goal_agent import GridGoalAgent
...
def build_and_train(config_file,
    ...
    agent = GridGoalAgent(initial_model_state_dict=model_checkpoint, **config['agent'])
    algo = GoalDSR(**config['algo'])
    ...
    name = "sf_goal_" + env_id
    log_dir = "train_sf_goal"
