...
def build_and_train(env_id="MiniGrid-FourRooms-v0", run_ID=0, cuda_idx=None, snapshot_gap=None):
    ...
    if snapshot_gap is not None:
        ...
        with logger_context(log_dir, run_ID, name, config, snapshot_mode=None, tensorboard=True):
            runner.train()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--snapshot_gap', help='iterations between snapshots ', type=int, default=None)
